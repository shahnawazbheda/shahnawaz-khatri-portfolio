...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section id="home" className="relative pt-28 md:pt-36 pb-20 px-6 md:px-16 max-w-7xl mx-auto z-10">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <motion.span
              ...
              className="text-3xl md:text-5xl inline-block origin-bottom-right select-none"
            >
              👋
            </motion.span>
          </div>
          ...
          <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-500 flex items-center min-h-[48px] tracking-wide">
            <span>{displayedText}</span>
            <span className="inline-block w-[3px] h-8 md:h-10 bg-blue-500 ml-2 animate-[pulse_0.8s_ease-in-out_infinite]" />
          </div>
        </motion.div>
      ...
      <div className="mt-28 pt-16 border-t border-white/5 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">

        {/* Left Column: Bio Paragraphs with Staggered Scroll Reveal */}
        <div className="lg:col-span-7 space-y-6 text-base md:text-lg text-white/90 leading-relaxed font-sans font-normal">
          <motion.p
        ...
        <div className="lg:col-span-5 flex justify-center">
          <motion.div
            ...
            className="relative w-full max-w-[340px] aspect-[4/5] rounded-2xl overflow-hidden border border-blue-500/30 shadow-[0_0_35px_rgba(37,99,235,0.25)] bg-[#0A0D14] group"
          >
            <img
      ...
      >
        <h3 className="text-6xl md:text-6xl font-extrabold uppercase tracking-tight text-white">
          <span>FIND </span>
